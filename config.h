...
static Color colors[] = {
	...
	[RED] =     { .fg = COLOR_RED,   .bg = -1, .fg256 = 160, .bg256 = -1, },
	[DARK_ORANGE] = {
        // .fg = COLOR_YELLOW, .bg = -1, .fg256 = 208, .bg256 = -1,
        .fg = COLOR_YELLOW, .bg = -1, .fg256 = 130, .bg256 = -1,
    },
	[GRAY] = {
        .fg = -1, .bg = -1, .fg256 = 242, .bg256 = -1,
    },
};
...
#define SELECTED_ATTR   (COLOR(DARK_ORANGE) | A_NORMAL)
...
#define BAR_ATTR        (COLOR(DARK_ORANGE) | A_NORMAL)
